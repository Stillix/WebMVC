...
<form action="/WebMVC_war_exploded/controller" method="post">
    <input type="hidden" name="command" value="find_user_notice">
    <input type="submit" value="Your notices" style="font-weight: bold; font-size: 18px; padding: 10px;">
</form>
<br><br>
<br><br>
<form action="/WebMVC_war_exploded/controller" method="post">
...
<br>
Для заполнения формы заявки перейдите на <a href="pages/form_notice.jsp">страницу заявки</a><br>
Для для изменения информации о заявке перейдите на<a href="pages/change_notice_info.jsp">страницу редактирования заявки</a><br>
</body>
</html>
