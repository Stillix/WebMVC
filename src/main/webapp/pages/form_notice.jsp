...
<form action="/WebMVC_war_exploded/controller" method="post">
    ...
    Заголовок: <input type="text" name="title" maxlength="45"  placeholder="Введите заголовок" required>${errorTitleMessage}<br>
    ...
    Возраст : <input type="text" name="age" maxlength="13" placeholder="Введите возраст " required>${errorAgeMessage}<br>
